...
@pytest.mark.parametrize('url', [pytest.lazy_fixture('NEWS_DETAIL')])
...
@pytest.mark.parametrize('url', [pytest.lazy_fixture('COMMENT_EDIT')])
...
@pytest.mark.parametrize('url', [pytest.lazy_fixture('COMMENT_DELETE')])
